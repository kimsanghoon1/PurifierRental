...
public class Order {
    ...
    public void onPostPersist() {
        // Get request from Company
        //purifierrental.external.Company company =
        //    Application.applicationContext.getBean(purifierrental.external.CompanyService.class)
        //    .getCompany(/** mapping value needed */);
